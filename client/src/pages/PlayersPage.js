...
class PlayersPage extends React.Component {
    ...
    updateSearchResults() {
        ...
        getPlayerSearch(this.state.nameQuery, this.state.nationalityQuery, this.state.clubQuery, 
                        this.state.ratingHighQuery, this.state.ratingLowQuery, this.state.potHighQuery, 
                        this.state.potLowQuery, null, null).then(res => {
            ...
            <div>
                ...
                <Form style={{ width: '80vw', margin: '0 auto', marginTop: '5vh' }}>
                    <Row>
                        ...
                        <Col flex={2}><FormGroup style={{ width: '20vw', margin: '0 auto' }}>
                            <label>Club</label>
                            <FormInput placeholder="Name" value={this.state.clubQuery} onChange={this.handleClubQueryChange} />
                        </FormGroup></Col>
                    </Row>
                    <br></br>
                    <Row>
